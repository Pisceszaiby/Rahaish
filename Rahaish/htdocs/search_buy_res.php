...
<body>
    ...
    //buy residential
    error_reporting(0);
    $buy_res_min_area = $_POST['buy_res_min_area'];
    $buy_res_max_area = $_POST['buy_res_max_area'];
    $buy_res_location = $_POST['buy_res_location'];
    $buy_res_classification = $_POST['buy_res_classification'];
    ...
    where society_name='$buy_res_location'
    and property_type='Residential'
    and property_classification='$buy_res_classification'
    and price<='$buy_res_max_area' and price >='$buy_res_min_area';";
