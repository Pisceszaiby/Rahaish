...
<head>
    <meta charset="utf-8">
    <title>Buy Classification</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="buyClassification.css">
    <link rel="stylesheet" href="styles.css">

</head>

<body>
    <div class="buyClassification">
        ...
        <form action="buy_residential.php">
        ...
        <form action="buy_commercial.php">
