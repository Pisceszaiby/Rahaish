...
<head>
    ...
    <link rel="stylesheet" href="search_rent_com.css">
    <link rel="stylesheet" href="styles.css">


    <title>Search Rent Commercial</title>
</head>
...
<body>
    ...
    //buy residential
    error_reporting(0);
    $rent_com_min_area = $_POST['rent_com_min_area'];
    $rent_com_max_area = $_POST['rent_com_max_area'];
    $rent_com_location = $_POST['rent_com_location'];
    $rent_com_classification = $_POST['rent_com_classification'];
    ...
    $sql = "SELECT user_name AS 'Property Agent', rent_price,address_desc,property_id
    from rent_searching
    where society_name='$rent_com_location'
    and property_type='Commercial'
    and property_classification='$rent_com_classification'
    and rent_price<='$rent_com_max_area' and rent_price >='$rent_com_min_area';";
    ...
    if (is_null($row)) {
        ...
        $heading = " Commercial " . $rent_com_classification . " for Buying in " . $rent_com_location . " in price range Rs "
            . $rent_com_min_area . " - " . $rent_com_max_area;
